    ...
    <div className="flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20">
        ...
        <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vh] md:mb-[-30px]">
          ...
          <div className="flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light">
            ...
            <p>Explore our wide network of reliable doctors and  <br className="hidden sm:block"/> easily book your appointment without any hassle.</p>
          </div>
          <a href="" className="flex items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300">
            Book Appointment <img className="w-6" src={assets.arrow_icon} alt="" />
          </a>
        </div>

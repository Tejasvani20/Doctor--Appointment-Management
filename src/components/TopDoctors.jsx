...
//         <h1 className="text-3xl font-medium">Book Appointments with Top-Rated Doctors </h1>
...
//             ))}
//         </div>
//         <button onClick ={()=>{navigate('/doctors');scrollTo(0,0)}}className="  bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10 font-bold">More</button>
//     </div>
//   )
// }
        ...
        <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 pt-5 gap-y-6 px-3 sm:px-0">
                {doctors.slice(0, 10).map((item, index) => (
                    ...
                    >
                        <img className="bg-blue-50" src={item.image} alt={`Image of Dr. ${item.name}`} />
                        <div className="p-4">
                            <div className="flex items-center gap-2 text-sm text-center text-green-500">
                                <p className="w-2 h-2 bg-green-500 rounded-full"></p>
                                <p>Available</p>
